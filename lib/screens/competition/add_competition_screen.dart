...
class AddCompetitionScreen extends StatefulWidget {
  ...
  @override
  State<AddCompetitionScreen> createState() => AddCompetitionScreenState();
}

class AddCompetitionScreenState extends State<AddCompetitionScreen> {
  List add = [];
  bool launch = false;
  String env = "Dev";
  ...
  Future addCompetition() async{
    ...
    var response = await CompetitionRequests().addCompetition(title, description,
        link, date, contacts, picture, country, env);
        ...
        appBar: AppBar(
            ...
            title: Row(
                children: [
                  ...
                  const Text("Gestion des concours")
                ]
            )
        ),
