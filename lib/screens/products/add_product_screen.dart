...
class AddProductScreenState extends State<AddProductScreen> {
  ...
  Future addProduct() async{
    ...
    var response = await ProductRequests().addProduct(name, description, weekPrice,
        monthPrice, yearPrice, date, level, subjects, picture, file, country,
        levelValue, subjectValue, index, env);
                          ...
                          children: [
                            ...
                            TextFormField(
                                ...
                                decoration: const InputDecoration(
                                    labelText: "Date dernier produit",
